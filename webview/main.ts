...
type EutherBooksModelBackend = "voxcpm2" | "dots.tts-soar" | "dots.tts-mf" | "grapheneos-matcha-en" | "auto-fallback";
...
const appDownloads: AppDownload[] = [
  ...
  },
  {
    ...
    href: "/downloads/BusMancer-0.1.0-alpha12-debug.apk",
    status: "Alpha APK · v0.1.0-alpha12 · Receive-only Classic SPP probe · Device reports",
  },
  {
    title: "EutherTime",
  ...
  {
    title: "EutherBeam",
    detail: "Local Samsung, NEC and Android TV control with persistent player rooms and Cast-to-CEC Samsung wake",
    platform: "Android phone · Samsung + NEC + Android TV",
    href: "/downloads/EutherBeam-0.1.0-alpha10-debug.apk",
    status: "Alpha APK · v0.1.0-alpha.10 · Persistent puck pairing · Cast + HDMI-CEC wake · No cloud",
  },
  {
    title: "Sakura Sprint",
    ...
    href: "/downloads/EutherSurfer-1.1.4-preview-debug.apk",
    status: "Preview APK · v1.1.4 · Personal top 10 · PB-only global posting · Tester feedback actions · Debug-signed",
  },
  {
    title: "EutherVox",
    ...
    status: "Beta APK · v0.19.0-beta.20 · Temperatur väljs före tvättschema · tydlig lagrad schemastatus · lokal readback · WSS",
  },
  {
    title: "EutherPing",
    ...
    href: "/downloads/EutherPing-0.8.24-debug.apk",
    status: "Ratchet Beta · v0.8.24 · Minimal composer · Call shortcuts",
  },
  {
    title: "EutherWire",
...
function eutherBooksVoiceGroups(): Array<[string, EutherBooksVoice[]]> {
  const voices = eutherBooksVoices.length
    ...
    : [
        ...
        { id: "auto-sv-female-warm", label: "Auto fallback warm female narrator", language: "sv", backend: "eutherlink", path: "preset:sv-female-warm", model_backend: "auto-fallback", default_length_scale: 1.15, default_seed: 774928057 },
        { id: "auto-en-female-warm", label: "Auto fallback English warm female narrator", language: "en", backend: "eutherlink", path: "preset:en-female-warm", model_backend: "auto-fallback", default_length_scale: 1.15, default_seed: 2073739982 },
...
function eutherBooksModelOptions(): string {
  ...
  return [
    ...
    `<option value="auto-fallback" ${active === "auto-fallback" ? "selected" : ""}>Auto fallback</option>`,
...
function normalizeEutherBooksModelBackend(value: string): EutherBooksModelBackend {
  ...
  return normalized === "dots.tts-mf" || normalized === "dots.tts-soar" || normalized === "grapheneos-matcha-en" || normalized === "auto-fallback" ? normalized : "voxcpm2";
}
...
function eutherBooksBaseVoiceId(voiceId: string): string {
  ...
  if (lower.startsWith("auto-")) {
    return normalized.slice("auto-".length);
  }
  return normalized;
}
...
function eutherBooksVoiceIdForModelBackend(baseVoiceId: string, modelBackend: EutherBooksModelBackend, language: string): string {
  ...
  if (modelBackend === "auto-fallback") {
    return `auto-${baseVoiceId === "own-en" || baseVoiceId === "own-sv" ? language === "en" ? "en-female-warm" : "sv-female-warm" : baseVoiceId}`;
  }
