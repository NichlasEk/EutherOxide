...
const appDownloads: AppDownload[] = [
  ...
  {
    title: "EutherMajn",
    detail: "Playable Rust voxel sandbox with readable material counts and discoverable fictional charge crafting",
    platform: "Android phone · Game prototype",
    href: "/downloads/EutherMajn-0.6.0-debug.apk",
    status: "Prototype APK · v0.6.0 · Clear recipe feedback + starter copper",
  },
  {
    title: "BusMancer",
  ...
  {
    title: "Sakura Sprint",
    detail: "Colorful endless runner where a customizable Japanese macaque dodges festival obstacles, collects sushi and competes globally",
    platform: "Android phone · Game prototype",
    href: "/downloads/EutherSurfer-0.5.0-debug.apk",
    status: "Prototype APK · v0.5.0 · Adaptive Japanese soundtrack · Global top 30",
  },
  {
    title: "EutherVox",
  ...
  },
  {
    ...
    href: "/downloads/EutherPing-0.8.21-debug.apk",
    status: "Ratchet Beta · v0.8.21 · Cinematic terminal sounds · Optional mute",
  },
  {
    title: "EutherWire",
