...
fn default_store_items() -> Vec<ConfigStoreItem> {
    vec![
        ...
        ConfigStoreItem {
            id: "autoinjector".to_string(),
            label: "Autoinjector".to_string(),
            price: 210,
            detail: "Single-dose dart with rude bedside manner".to_string(),
            weapon: Some(WeaponId::Autoinjector.key().to_string()),
            ammo: 24,
            armor: 0,
        },
        ConfigStoreItem {
            id: "needlegun".to_string(),
            label: "Needlegun".to_string(),
            price: 275,
            detail: "Rapid insurance-approved acupuncture".to_string(),
            weapon: Some(WeaponId::Needlegun.key().to_string()),
            ammo: 120,
            armor: 0,
        },
        ConfigStoreItem {
            id: "handsanitizer_flamethrower".to_string(),
            label: "Handsanitizer Flamethrower".to_string(),
            price: 325,
            detail: "Kills 99.9% of queue escalation".to_string(),
            weapon: Some(WeaponId::HandSanitizerFlamethrower.key().to_string()),
            ammo: 90,
            armor: 0,
        },
        ConfigStoreItem {
